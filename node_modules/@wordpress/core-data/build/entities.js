...
const rootEntitiesConfig = [{
  ...
  getTitle: record => {
    ...
    return (_record$title = record === null || record === void 0 ? void 0 : record.title) !== null && _record$title !== void 0 ? _record$title : (0, _i18n.__)('Site Title');
  }
}, {
  ...
  return Object.entries(postTypes !== null && postTypes !== void 0 ? postTypes : {}).map(_ref => {
    ...
    return {
      ...
      getTitle: record => {
        ...
        return (record === null || record === void 0 ? void 0 : (_record$title3 = record.title) === null || _record$title3 === void 0 ? void 0 : _record$title3.rendered) || (record === null || record === void 0 ? void 0 : record.title) || (isTemplate ? (0, _changeCase.capitalCase)((_record$slug = record.slug) !== null && _record$slug !== void 0 ? _record$slug : '') : String(record.id));
      },
