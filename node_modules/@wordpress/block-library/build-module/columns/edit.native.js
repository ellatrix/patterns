...
import { InspectorControls, InnerBlocks, BlockControls, BlockVerticalAlignmentToolbar, BlockVariationPicker, useSetting, store as blockEditorStore } from '@wordpress/block-editor';
...
function ColumnsEditContainer(_ref) {
  ...
  return createElement(Fragment, null, isSelected && createElement(Fragment, null, createElement(InspectorControls, null, createElement(PanelBody, {
...
const ColumnsEdit = props => {
  ...
  return createElement(View, {
    style: style
  }, createElement(ColumnsEditContainerWrapper, _extends({
