...
import { RichText, getColorClassName, InnerBlocks, __experimentalGetGradientClass, useBlockProps, useInnerBlocksProps } from '@wordpress/block-editor';
...
import { IMAGE_BACKGROUND_TYPE, VIDEO_BACKGROUND_TYPE, getPositionClassName, isContentPositionCenter, dimRatioToClass, mediaPosition } from './shared';
...
const v8 = {
  ...
  save(_ref4) {
    ...
    return createElement("div", useBlockProps.save({
      ...
      "aria-hidden": "true",
      className: classnames(overlayColorClass, dimRatioToClass(dimRatio), 'wp-block-cover__gradient-background', gradientClass, {
        'has-background-dim': dimRatio !== undefined,
...
const v7 = {
  ...
  save(_ref5) {
    ...
    const objectPosition = // prettier-ignore
    focalPoint && isImgElement ? `${Math.round(focalPoint.x * 100)}% ${Math.round(focalPoint.y * 100)}%` : undefined;
    const classes = classnames(dimRatioToClassV1(dimRatio), overlayColorClass, {
...
const v3 = {
  ...
  migrate(attributes) {
    ...
    return [restAttributes, [createBlock('core/paragraph', {
...
const v2 = {
  ...
  save(_ref10) {
    ...
    const classes = classnames('wp-block-cover-image', dimRatioToClassV1(dimRatio), overlayColorClass, {
      'has-background-dim': dimRatio !== 0,
      'has-parallax': hasParallax,
      [`has-${contentAlign}-content`]: contentAlign !== 'center'
...
const v1 = {
  ...
  save(_ref11) {
    ...
    const style = backgroundImageStyles(url);
    const classes = classnames('wp-block-cover-image', dimRatioToClassV1(dimRatio), {
      'has-background-dim': dimRatio !== 0,
      'has-parallax': hasParallax
    }, align ? `align${align}` : null);
