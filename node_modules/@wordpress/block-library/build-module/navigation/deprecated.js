...
const deprecated = [v6, v5, v4, // Remove `isResponsive` attribute.
{
  ...
  migrate: compose(migrateIdToRef, migrateWithLayout, migrateFontFamily, migrateIsResponsive),
  ...
  migrate: compose(migrateIdToRef, migrateWithLayout, migrateFontFamily, migrateTypographyPresets)
}, {
  attributes: {
    className: {
      type: 'string'
