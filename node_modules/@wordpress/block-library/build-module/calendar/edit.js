...
export default function CalendarEdit(_ref) {
  ...
  if (!hasPosts) {
    return createElement("div", blockProps, createElement(Placeholder, {
      icon: icon,
      label: __('Calendar')
    }, !hasPostsResolved ? createElement(Spinner, null) : __('No published posts found.')));
  }

  return createElement("div", blockProps, createElement(Disabled, null, createElement(ServerSideRender, {
    block: "core/calendar",
