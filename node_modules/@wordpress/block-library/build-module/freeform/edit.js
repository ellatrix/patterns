...
export default function FreeformEdit(props) {
  ...
  return createElement(Fragment, null, canRemove && createElement(BlockControls, null, createElement(ToolbarGroup, null, createElement(ConvertToBlocksButton, {
    clientId: clientId
  }))), createElement("div", useBlockProps({
    ref
  }), isIframed ? createElement(ModalEdit, props) : createElement(ClassicEdit, props)));
}
