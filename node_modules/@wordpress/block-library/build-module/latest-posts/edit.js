...
export default function LatestPostsEdit(_ref) {
  ...
  const {
    ...
    return {
      defaultImageWidth: get(settings.imageDimensions, [featuredImageSizeSlug, 'width'], 0),
      defaultImageHeight: get(settings.imageDimensions, [featuredImageSizeSlug, 'height'], 0),
  ...
  })), createElement("ul", blockProps, displayPosts.map(post => {
