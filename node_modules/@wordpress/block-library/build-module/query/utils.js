...
export const usePostTypes = () => {
  ...
  const postTypesSelectOptions = useMemo(() => (postTypes || []).map(_ref2 => {
    let {
      labels,
      slug
    } = _ref2;
...
export function useAllowedControls(attributes) {
  return useSelect(select => {
    ...
    return (_select$getActiveBloc = select(blocksStore).getActiveBlockVariation(queryLoopName, attributes)) === null || _select$getActiveBloc === void 0 ? void 0 : _select$getActiveBloc.allowedControls;
  }, [attributes]);
}
