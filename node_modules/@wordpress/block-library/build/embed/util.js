...
const getEmbedInfoByProvider = provider => {
  ...
  return (_getBlockVariations = (0, _blocks.getBlockVariations)(DEFAULT_EMBED_BLOCK)) === null || _getBlockVariations === void 0 ? void 0 : _getBlockVariations.find(_ref => {
    let {
      name
    } = _ref;
...
const findMoreSuitableBlock = url => {
  ...
  return (_getBlockVariations2 = (0, _blocks.getBlockVariations)(DEFAULT_EMBED_BLOCK)) === null || _getBlockVariations2 === void 0 ? void 0 : _getBlockVariations2.find(_ref2 => {
    let {
      patterns
    } = _ref2;
...
const createUpgradedEmbedBlock = function (props) {
  ...
  const isCurrentBlockWP = providerNameSlug === 'wordpress' || type === _constants.WP_EMBED_TYPE; // If current block is not WordPress and a more suitable block found
  ...
  const wpVariation = (_getBlockVariations3 = (0, _blocks.getBlockVariations)(DEFAULT_EMBED_BLOCK)) === null || _getBlockVariations3 === void 0 ? void 0 : _getBlockVariations3.find(_ref3 => {
    let {
      name
    } = _ref3;
...
const getAttributesFromPreview = (0, _memize.default)(function (preview, title, currentClassNames, isResponsive) {
  ...
  const providerNameSlug = (0, _lodash.kebabCase)((providerName || title).toLowerCase());
