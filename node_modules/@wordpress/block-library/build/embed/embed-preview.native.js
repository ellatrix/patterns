...
const EmbedPreview = _ref => {
  ...
  const embedWrapper = (0, _element.createElement)(_element.Fragment, null, (0, _element.createElement)(_reactNative.TouchableWithoutFeedback, {
    onPress: () => {
      if (onFocus) {
        onFocus();
      }
  ...
  return (0, _element.createElement)(_reactNative.TouchableWithoutFeedback, {
    ...
    disabled: !isSelected
  }, (0, _element.createElement)(_primitives.View, null, isProviderPreviewable && previewable ? embedWrapper : (0, _element.createElement)(_embedNoPreview.default, {
    label: label,
    icon: icon,
