...
function LinkSettings(_ref) {
  ...
  }, (0, _element.createElement)(_components.LinkSettingsNavigation, {
...
class ImageEdit extends _element.Component {
  ...
  componentDidUpdate(previousProps) {
    ...
    if (!previousProps.image && image) {
      if (!(0, _url.hasQueryArg)(url, 'w') && attributes !== null && attributes !== void 0 && attributes.sizeSlug) {
  ...
  render() {
    ...
    }), this.getAltTextSettings()), (0, _element.createElement)(LinkSettings, {
    ...
    const imageContainerStyles = [(context === null || context === void 0 ? void 0 : context.fixedHeight) && _styles.default.fixedHeight];
...
var _default = (0, _compose.compose)([(0, _data.withSelect)((select, props) => {
  ...
  return {
    ...
    imageSizes,
    imageDefaultSize,
    shouldUseFastImage: (capabilities === null || capabilities === void 0 ? void 0 : capabilities.shouldUseFastImage) === true,
    featuredImageId,
