...
exports.getTransformedBlocksFromPattern = exports.getEntitiesInfo = void 0;
...
const usePostTypes = () => {
  ...
  const postTypesSelectOptions = (0, _element.useMemo)(() => (postTypes || []).map(_ref2 => {
    let {
      labels,
      slug
    } = _ref2;
...
function useIsPostTypeHierarchical(postType) {
  return (0, _data.useSelect)(select => {
    const type = select(_coreData.store).getPostType(postType);
...
function useAllowedControls(attributes) {
  return (0, _data.useSelect)(select => {
    ...
    return (_select$getActiveBloc = select(_blocks.store).getActiveBlockVariation(queryLoopName, attributes)) === null || _select$getActiveBloc === void 0 ? void 0 : _select$getActiveBloc.allowedControls;
  }, [attributes]);
}
