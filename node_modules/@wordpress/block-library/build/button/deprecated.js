...
function migrateAlign(attributes) {
  ...
  return { ...otherAttributes,
    className: (0, _classnames.default)(otherAttributes.className, `align${attributes.align}`)
  };
}
...
const deprecated = [v11, v10, {
  ...
  save(_ref5) {
    ...
    const colorProps = (0, _blockEditor.__experimentalGetColorClassesAndStyles)(attributes);
    const buttonClasses = (0, _classnames.default)('wp-block-button__link', colorProps.className, {
  ...
  migrate: (0, _compose.compose)(_migrateFontFamily.default, migrateBorderRadius)
}, {
  supports: {
    anchor: true,
    align: true,
  ...
  save(_ref8) {
    ...
    const buttonClasses = (0, _classnames.default)('wp-block-button__link', {
      'no-border-radius': borderRadius === 0
    });
    const buttonStyle = {
      borderRadius: borderRadius ? borderRadius + 'px' : undefined
  ...
  migrate: (0, _compose.compose)(migrateBorderRadius, migrateCustomColorsAndGradients, migrateAlign),
  ...
  save(_ref9) {
    ...
    const backgroundClass = !customGradient && (0, _blockEditor.getColorClassName)('background-color', backgroundColor);
