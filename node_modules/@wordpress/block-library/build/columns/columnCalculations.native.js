...
const MIN_WIDTH = (_styles$columnsContai = _editor.default.columnsContainer) === null || _styles$columnsContai === void 0 ? void 0 : _styles$columnsContai.minWidth;
/**
...
const MARGIN = (_styles$columnsContai2 = _editor.default.columnsContainer) === null || _styles$columnsContai2 === void 0 ? void 0 : _styles$columnsContai2.marginLeft;
...
const getContentWidths = (columnsInRow, width, columnCount, innerColumns, globalStyles) => {
  ...
  const columnWidths = (0, _utils.getColumnWidths)(innerColumns, columnCount); // Array of column width attribute values
