...
class MediaTextEdit extends _element.Component {
  ...
  render() {
    ...
    }, ((style === null || style === void 0 ? void 0 : style.backgroundColor) || backgroundColor.color) && _style.default.innerBlockPaddings];
    const containerStyles = { ..._style.default['wp-block-media-text'],
      ...
      backgroundColor: (style === null || style === void 0 ? void 0 : style.backgroundColor) || backgroundColor.color,
      paddingBottom: 0
    };
    const mediaContainerStyle = [{
      flex: 1
    }, shouldStack ? { ...(mediaPosition === 'left' && _style.default.mediaStackLeft),
...
var _default = (0, _compose.compose)((0, _blockEditor.withColors)('backgroundColor'), (0, _data.withSelect)((select, _ref2) => {
  let {
    clientId
  } = _ref2;
  const {
