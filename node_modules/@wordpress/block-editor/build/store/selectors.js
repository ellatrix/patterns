...
exports.getClientIdsWithDescendants = exports.getClientIdsOfDescendants = exports.getBlocksByClientId = void 0;
...
exports.getInserterItems = exports.getGlobalBlockCount = void 0;
...
const __unstableGetClientIdsTree = (0, _rememo.default)(function (state) {
...
const getBlockParents = (0, _rememo.default)(function (state, clientId) {
...
const getBlockParentsByBlockName = (0, _rememo.default)(function (state, clientId, blockName) {
...
const canInsertBlockType = (0, _rememo.default)(canInsertBlockTypeUnmemoized, (state, blockName, rootClientId) => [state.blockListSettings[rootClientId], state.blocks.byClientId.get(rootClientId), state.settings.allowedBlockTypes, state.settings.templateLock]);
/**
...
const getInserterItems = (0, _rememo.default)(function (state) {
...
const hasInserterItems = (0, _rememo.default)(function (state) {
  let rootClientId = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
...
const getAllowedBlocks = (0, _rememo.default)(function (state) {
  let rootClientId = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
  ...
  return (0, _blocks.getBlockTypes)().filter(blockType => canIncludeBlockTypeInInserter(state, blockType, rootClientId));
}, (state, rootClientId) => [state.blockListSettings[rootClientId], state.blocks.byClientId, state.settings.allowedBlockTypes, state.settings.templateLock, (0, _blocks.getBlockTypes)()]);
exports.getAllowedBlocks = getAllowedBlocks;

const __experimentalGetAllowedBlocks = (0, _rememo.default)(function (state) {
  let rootClientId = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
...
const __experimentalGetDirectInsertBlock = (0, _rememo.default)(function (state) {
...
const getPatternsByBlockTypes = (0, _rememo.default)(function (state, blockNames) {
  let rootClientId = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
...
const __experimentalGetPatternsByBlockTypes = (0, _rememo.default)(function (state, blockNames) {
  let rootClientId = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
...
const __experimentalGetPatternTransformItems = (0, _rememo.default)(function (state, blocks) {
  let rootClientId = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
...
const __experimentalGetBlockListSettingsForBlocks = (0, _rememo.default)(function (state) {
