...
const getMovementDirection = (moveDirection, orientation) => {
  if (moveDirection === 'up') {
    if (orientation === 'horizontal') {
      return (0, _i18n.isRTL)() ? 'right' : 'left';
    }

    return 'up';
  } else if (moveDirection === 'down') {
    if (orientation === 'horizontal') {
      return (0, _i18n.isRTL)() ? 'left' : 'right';
    }
...
function getMultiBlockMoverDescription(selectedCount, firstIndex, isFirst, isLast, dir, orientation) {
  ...
  if (isFirst && isLast) {
    ...
    return (0, _i18n.__)('All blocks are selected, and cannot be moved');
  }
  ...
  if (dir > 0 && !isLast) {
    ...
    if (movementDirection === 'down') {
      ...
      (0, _i18n.__)('Move %1$d blocks from position %2$d down by one place'), selectedCount, position);
    }

    if (movementDirection === 'left') {
      return (0, _i18n.sprintf)( // translators: 1: Number of selected blocks, 2: Position of selected blocks
      (0, _i18n.__)('Move %1$d blocks from position %2$d left by one place'), selectedCount, position);
    }

    if (movementDirection === 'right') {
      return (0, _i18n.sprintf)( // translators: 1: Number of selected blocks, 2: Position of selected blocks
      (0, _i18n.__)('Move %1$d blocks from position %2$d right by one place'), selectedCount, position);
    }
  }
  ...
  if (dir > 0 && isLast) {
    ...
    if (movementDirection === 'left') {
      return (0, _i18n.__)('Blocks cannot be moved left as they are already are at the leftmost position');
    }

    if (movementDirection === 'right') {
      return (0, _i18n.__)('Blocks cannot be moved right as they are already are at the rightmost position');
    }
  }
  ...
  if (dir < 0 && !isFirst) {
    ...
    if (movementDirection === 'up') {
      return (0, _i18n.sprintf)( // translators: 1: Number of selected blocks, 2: Position of selected blocks
      (0, _i18n.__)('Move %1$d blocks from position %2$d up by one place'), selectedCount, position);
    }
