...
function ButtonBlockAppender(_ref, ref) {
  ...
  return (0, _element.createElement)(_inserter.default, {
    ...
    renderToggle: _ref2 => {
      ...
      let inserterButton = (0, _element.createElement)(_components.Button, {
        ref: ref,
        onFocus: onFocus,
        tabIndex: tabIndex,
...
const ButtonBlockerAppender = (0, _element.forwardRef)((props, ref) => {
...
exports.ButtonBlockerAppender = ButtonBlockerAppender;
