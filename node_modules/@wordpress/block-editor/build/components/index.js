...
var _exportNames = {
  ...
  BlockList: true,
  useBlockProps: true,
  __experimentalLayoutStyle: true,
  BlockMover: true,
  BlockPreview: true,
...
Object.defineProperty(exports, "__experimentalLayoutStyle", {
  enumerable: true,
  get: function () {
    return _layout.LayoutStyle;
  }
});
...
Object.defineProperty(exports, "__unstableUseClipboardHandler", {
  enumerable: true,
  get: function () {
    return _copyHandler.useClipboardHandler;
  }
});
...
Object.keys(_duotone).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (Object.prototype.hasOwnProperty.call(_exportNames, key)) return;
  if (key in exports && exports[key] === _duotone[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _duotone[key];
