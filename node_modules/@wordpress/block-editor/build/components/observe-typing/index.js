 ...
 * @type {Set<number>}
 */
const KEY_DOWN_ELIGIBLE_KEY_CODES = new Set([_keycodes.UP, _keycodes.RIGHT, _keycodes.DOWN, _keycodes.LEFT, _keycodes.ENTER, _keycodes.BACKSPACE]);
/**
...
function useTypingObserver() {
  ...
  const ref2 = (0, _compose.useRefEffect)(node => {
    const {
      ownerDocument
    } = node;
    const {
