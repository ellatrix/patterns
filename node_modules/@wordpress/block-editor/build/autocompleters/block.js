  ...
  return {
    ...
    useItems(filterValue) {
      ...
      const filteredItems = (0, _element.useMemo)(() => {
        const initialFilteredItems = !!filterValue.trim() ? (0, _searchItems.searchBlockItems)(items, categories, collections, filterValue) : (0, _sorting.orderBy)(items, 'frecency', 'desc');
