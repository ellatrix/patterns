...
export function BlockSettingsDropdown(_ref2) {
  ...
  const removeBlockLabel = count === 1 ? label : __('Remove blocks'); // Allows highlighting the parent block outline when focusing or hovering
  ...
  return createElement(BlockActions, {
    ...
    return createElement(DropdownMenu, _extends({
      ...
      return createElement(Fragment, null, createElement(MenuGroup, null, createElement(__unstableBlockSettingsMenuFirstItem.Slot, {
        fillProps: {
          onClose
        }
      }), !parentBlockIsSelected && !!firstParentClientId && createElement(MenuItem, _extends({}, showParentOutlineGestures, {
        ref: selectParentButtonRef,
      ...
      }, __('Insert after'))), canMove && !onlyBlock && createElement(MenuItem, {
