...
import { useState, useLayoutEffect, useReducer, useMemo, useRef } from '@wordpress/element';
...
function useMovingAnimation(_ref) {
  ...
  const previous = useMemo(() => ref.current ? getAbsolutePosition(ref.current) : null, [triggerAnimationOnChange]); // Calculate the previous position of the block relative to the viewport and
