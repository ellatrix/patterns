...
export function useTypewriter() {
  const hasSelectedBlock = useSelect(select => select(blockEditorStore).hasSelectedBlock(), []);
  return useRefEffect(node => {
    ...
    function maintainCaretPosition(_ref) {
      ...
      const scrollContainer = getScrollContainer(node); // The page must be scrollable.
