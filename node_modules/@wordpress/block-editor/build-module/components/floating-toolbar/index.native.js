...
const FloatingToolbar = _ref => {
  ...
  const opacity = useRef(new Animated.Value(0)).current; // Sustain old selection for proper block selection button rendering when exit animation is ongoing.
  ...
  }, showNavUpButton && createElement(ToolbarGroup, {
