...
const defaultRenderToggle = _ref => {
  ...
  const expandedModeViewText = createElement(Text, {
...
export class Inserter extends Component {
  ...
  renderInserterToggle(_ref3) {
    ...
    const style = useExpandedMode ? styles['inserter-menu__add-block-button-icon--expanded'] : getStylesFromColorScheme(styles['inserter-menu__add-block-button-icon'], styles['inserter-menu__add-block-button-icon--dark']);
    const containerStyle = getStylesFromColorScheme(styles['inserter-menu__add-block-button'], styles['inserter-menu__add-block-button--dark']);
