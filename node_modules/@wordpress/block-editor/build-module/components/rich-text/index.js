...
import { RawHTML, useRef, useCallback, forwardRef, createContext } from '@wordpress/element';
...
function RichTextWrapper(_ref, forwardedRef) {
  ...
  return createElement(Fragment, null, isSelected && createElement(keyboardShortcutContext.Provider, {
