...
const withFontSizeInlineStyles = createHigherOrderComponent(BlockListBlock => props => {
  ...
  if (!hasBlockSupport(blockName, FONT_SIZE_SUPPORT_KEY) || shouldSkipSerialization(blockName, TYPOGRAPHY_SUPPORT_KEY, 'fontSize') || !fontSize || style !== null && style !== void 0 && (_style$typography3 = style.typography) !== null && _style$typography3 !== void 0 && _style$typography3.fontSize) {
...
function addTransforms(result, source, index, results) {
  ...
  const activeSupports = {
    fontSize: hasBlockSupport(destinationBlockType, FONT_SIZE_SUPPORT_KEY)
  };
...
function addEditPropsForFluidCustomFontSizes(blockType) {
  ...
  blockType.getEditWrapperProps = attributes => {
    ...
    const fluidTypographyConfig = (_select$getSettings$_ = select(blockEditorStore).getSettings().__experimentalFeatures) === null || _select$getSettings$_ === void 0 ? void 0 : (_select$getSettings$_2 = _select$getSettings$_.typography) === null || _select$getSettings$_2 === void 0 ? void 0 : _select$getSettings$_2.fluid;
