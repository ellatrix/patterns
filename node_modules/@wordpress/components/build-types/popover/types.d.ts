...
declare type PositionYAxis = 'top' | 'middle' | 'bottom';
declare type PositionXAxis = 'left' | 'center' | 'right';
declare type PositionCorner = 'top' | 'right' | 'bottom' | 'left';
declare type DomRectWithOwnerDocument = DOMRect & {
    ownerDocument?: Document;
};
declare type PopoverPlacement = Placement | 'overlay';
export declare type AnimatedWrapperProps = {
    placement: PopoverPlacement;
    shouldAnimate?: boolean;
};
export declare type PopoverAnchorRefReference = MutableRefObject<Element | null | undefined>;
export declare type PopoverAnchorRefTopBottom = {
    top: Element;
    bottom: Element;
};
...
export declare type PopoverProps = {
     ...
     */
    position?: `${PositionYAxis}` | `${PositionYAxis} ${PositionXAxis}` | `${PositionYAxis} ${PositionXAxis} ${PositionCorner}`;
    /**
