...
export declare type TreeGridRowProps = {
    /**
...
declare type RovingTabIndexItemPassThruProps = {
    ref: React.ForwardedRef<any>;
    tabIndex?: number;
    onFocus: React.FocusEventHandler<any>;
    [key: string]: any;
};
export declare type RovingTabIndexItemProps = {
    /**
...
export declare type TreeGridCellProps = ({
    /**
...
export declare type TreeGridProps = {
    /**
