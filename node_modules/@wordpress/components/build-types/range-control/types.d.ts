...
export declare type RangeControlProps<IconProps = unknown> = Pick<BaseControlProps, 'hideLabelFromVision' | 'help' | '__nextHasNoMarginBottom'> & MarksProps & {
    /**
...
export declare type WrapperProps = Pick<BaseControlProps, '__nextHasNoMarginBottom'> & {
    color?: CSSProperties['color'];
    marks?: RangeMarks;
};
