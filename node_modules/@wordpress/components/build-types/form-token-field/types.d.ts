...
export interface FormTokenFieldProps extends Pick<ComponentPropsWithRef<'input'>, 'autoCapitalize' | 'autoComplete' | 'className'> {
    label?: string;
    /**
 ...
 */
export interface SuggestionsListProps<T = string | (Record<string, unknown> & {
    value: string;
})> {
