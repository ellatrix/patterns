...
export declare type ToggleGroupControlOptionBaseProps = {
    children: ReactNode;
    /**
...
export declare type ToggleGroupControlOptionIconProps = Pick<ToggleGroupControlOptionBaseProps, 'value'> & {
    /**
...
export declare type ToggleGroupControlOptionProps = Pick<ToggleGroupControlOptionBaseProps, 'value' | 'showTooltip'> & {
    /**
...
export declare type ToggleGroupControlProps = Pick<BaseControlProps, 'help' | '__nextHasNoMarginBottom'> & {
    /**
...
declare type ToggleGroupControlAsRadioContext = {
    isDeselectable?: false;
} & RadioStateReturn;
declare type ToggleGroupControlAsButtonContext = {
    isDeselectable: true;
} & Pick<RadioStateReturn, 'state' | 'setState'>;
export declare type ToggleGroupControlContextProps = Pick<ToggleGroupControlProps, 'isBlock' | 'size'> & {
    baseId: string;
...
export declare type ToggleGroupControlMainControlProps = Pick<ToggleGroupControlProps, 'children' | 'isAdaptiveWidth' | 'label' | 'size'> & {
    onChange: (value: ReactText | undefined) => void;
    value?: ReactText;
};
export {};
