...
export declare type ComboboxControlOption = {
    label: string;
    value: string;
    [key: string]: any;
};
export declare type ComboboxControlProps = Pick<BaseControlProps, '__nextHasNoMarginBottom' | 'className' | 'label' | 'hideLabelFromVision' | 'help'> & {
    /**
