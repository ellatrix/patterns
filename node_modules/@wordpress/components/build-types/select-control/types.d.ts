...
export interface SelectControlProps extends Pick<InputBaseProps, '__next36pxDefaultSize' | 'disabled' | 'hideLabelFromVision' | 'label' | 'labelPosition' | 'prefix' | 'size' | 'suffix'>, Pick<BaseControlProps, 'help' | '__nextHasNoMarginBottom'> {
    /**
