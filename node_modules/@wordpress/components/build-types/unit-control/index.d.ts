 ...
 * ```
 */
export declare const UnitControl: import("react").ForwardRefExoticComponent<Omit<import("./types").UnitSelectControlProps, "unit"> & Omit<import("../number-control/types").NumberControlProps, "type" | "suffix" | "spinControls"> & {
