...
export declare type UnitControlOnChangeCallback = InputChangeCallback<{
...
export declare type UnitControlProps = Omit<UnitSelectControlProps, 'unit'> & Omit<NumberControlProps, 'spinControls' | 'suffix' | 'type'> & {
    /**
