...
export declare type BoxControlValue = {
    top?: string;
    right?: string;
    bottom?: string;
    left?: string;
};
declare type UnitControlPassthroughProps = Omit<UnitControlProps, 'label' | 'onChange' | 'onFocus' | 'onMouseOver' | 'onMouseOut' | 'units'>;
export declare type BoxControlProps = Pick<UnitControlProps, 'onMouseOver' | 'onMouseOut' | 'units'> & {
    /**
...
export declare type BoxControlInputControlProps = UnitControlPassthroughProps & {
...
export declare type BoxUnitControlProps = UnitControlPassthroughProps & Pick<UnitControlProps, 'onChange' | 'onFocus'> & {
    isFirst?: boolean;
    isLast?: boolean;
    isOnly?: boolean;
    label?: string;
...
export declare type BoxControlIconProps = {
    /**
     * @default 24
     */
    size?: number;
