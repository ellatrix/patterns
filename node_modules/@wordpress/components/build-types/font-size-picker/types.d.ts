...
export declare type FontSizePickerSelectProps = Pick<FontSizePickerProps, 'value' | 'size'> & {
...
export declare type FontSizePickerSelectOption = {
    key: string;
    name: string;
    value?: FontSize['size'];
    __experimentalHint?: string;
};
export declare type FontSizePickerToggleGroupProps = Pick<FontSizePickerProps, 'value' | 'size' | '__nextHasNoMarginBottom'> & {
    fontSizes: NonNullable<FontSizePickerProps['fontSizes']>;
    onChange: NonNullable<FontSizePickerProps['onChange']>;
};
