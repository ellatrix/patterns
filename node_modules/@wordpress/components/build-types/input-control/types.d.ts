 ...
 */
import type { CSSProperties, ReactNode, SyntheticEvent, HTMLInputTypeAttribute } from 'react';
...
export declare type InputChangeCallback<P = {}> = (nextValue: string | undefined, extra: {
 ...
 */
Omit<WordPressComponentProps<InputFieldProps, 'input', false>, 'stateReducer' | 'prefix' | 'isFocused' | 'setIsFocused' | 'paddingInlineStart' | 'paddingInlineEnd'> {
...
export declare type InputControlPrefixWrapperProps = {
    /**
     * The prefix to be inserted.
     */
    children: ReactNode;
};
export declare type InputControlSuffixWrapperProps = {
    /**
