 ...
 */
import type { CSSProperties, ReactEventHandler, Ref, VideoHTMLAttributes } from 'react';
/**
 * Internal dependencies
 */
import type { BaseControlProps } from '../base-control/types';
export declare type FocalPoint = Record<FocalPointAxis, number>;
export declare type FocalPointAxis = 'x' | 'y';
export declare type FocalPointPickerProps = Pick<BaseControlProps, 'help' | 'hideLabelFromVision' | 'label'> & {
    /**
...
export declare type FocalPointPickerControlsProps = {
    __nextHasNoMarginBottom?: boolean;
    /**
...
export declare type FocalPointPickerGridProps = {
    bounds: {
        width: number;
        height: number;
    };
...
export declare type FocalPointPickerMediaProps = Pick<VideoHTMLAttributes<HTMLVideoElement>, 'autoPlay' | 'muted'> & {
    alt: string;
    mediaRef?: Ref<HTMLDivElement | HTMLVideoElement | HTMLImageElement>;
    onLoad?: ReactEventHandler<HTMLVideoElement | HTMLImageElement>;
    src: string;
};
export declare type FocalPointProps = {
    isDragging: boolean;
