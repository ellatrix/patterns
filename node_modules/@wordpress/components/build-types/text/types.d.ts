...
export declare type TextSize = 'body' | 'caption' | 'footnote' | 'largeTitle' | 'subheadline' | 'title';
declare type TextVariant = 'muted';
declare type TextWeight = 100 | 200 | 300 | 400 | 500 | 600 | 700 | 800 | 900;
export interface Props extends TruncateProps {
     ...
     */
    adjustLineHeightForInnerControls?: boolean | 'large' | 'medium' | 'small' | 'xSmall';
    /**
