...
export declare const isCompleteBorder: (border?: Border | undefined) => boolean;
...
export declare const getSplitBorders: (border?: Border | undefined) => {
    top: Border;
    right: Border;
    bottom: Border;
    left: Border;
...
export declare const getCommonBorder: (borders?: Borders | undefined) => {
