...
function CheckboxControl(props) {
  ...
  const [showIndeterminateIcon, setShowIndeterminateIcon] = (0, _element.useState)(false); // Run the following callback every time the `ref` (and the additional
  // dependencies) change.
  ...
  const instanceId = (0, _compose.useInstanceId)(CheckboxControl);
  ...
  }, additionalProps)), showIndeterminateIcon ? (0, _element.createElement)(_icons.Icon, {
    icon: _icons.reset,
