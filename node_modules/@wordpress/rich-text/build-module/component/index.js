...
export function useRichText(_ref) {
  let {
    value = '',
    selectionStart,
    selectionEnd,
  ...
  const didMount = useRef(false); // Value updates must happen synchonously to avoid overwriting newer values.
  ...
  const mergedRefs = useMergeRefs([ref, useDefaultStyle(), useBoundaryStyle({
    ...
    isSelected,
    onSelectionChange
  }), useSelectionChangeCompat(), useRefEffect(() => {
    applyFromProps();
