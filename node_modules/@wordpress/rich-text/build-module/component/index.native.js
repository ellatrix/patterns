...
const flatColorPalettes = memize(colorsPalettes => [...((colorsPalettes === null || colorsPalettes === void 0 ? void 0 : colorsPalettes.theme) || []), ...((colorsPalettes === null || colorsPalettes === void 0 ? void 0 : colorsPalettes.custom) || []), ...((colorsPalettes === null || colorsPalettes === void 0 ? void 0 : colorsPalettes.default) || [])]);
...
export class RichText extends Component {
  constructor(_ref) {
    ...
    this.debounceCreateUndoLevel = debounce(this.onCreateUndoLevel, 1000); // This prevents a bug in Aztec which triggers onSelectionChange twice on format change.
  ...
  onKeyDown(event) {
    ...
    (_this$customEditableO = this.customEditableOnKeyDown) === null || _this$customEditableO === void 0 ? void 0 : _this$customEditableO.call(this, {
      ...
      ...event,
      key: RCTAztecView.KeyCodes[event === null || event === void 0 ? void 0 : event.keyCode]
    });
  ...
  handleTriggerKeyCodes(event) {
    ...
    if (triggeredOption) {
      ...
      const text = getTextContent(record); // Only respond to the trigger if the selection is on the start of text or line
  ...
  getLinkTextColor(defaultColor) {
    ...
    const customColor = (style === null || style === void 0 ? void 0 : style.linkColor) && colord(style.linkColor);
