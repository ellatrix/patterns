...
exports.useInputAndSelection = useInputAndSelection;
...
function useInputAndSelection(props) {
  ...
  return (0, _compose.useRefEffect)(element => {
    ...
    function handleSelectionChange() {
      ...
      const newActiveFormats = (0, _getActiveFormats.getActiveFormats)(newValue, EMPTY_ACTIVE_FORMATS); // Update the value with the new active formats.
