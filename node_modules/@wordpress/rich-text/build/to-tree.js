...
function toTree(_ref2) {
  ...
  for (let i = 0; i < formatsLength; i++) {
    ...
    !lastCharacter || lastCharacter === _specialCharacters.LINE_SEPARATOR || // Pad the line if the previous character is a line break, otherwise
    ...
    if (shouldInsertPadding && character === _specialCharacters.LINE_SEPARATOR) {
      let node = pointer;
    ...
    if (characterFormats) {
      characterFormats.forEach((format, formatIndex) => {
        ...
        const boundaryClass = isEditableTree && character !== _specialCharacters.LINE_SEPARATOR && format === deepestActiveFormat;
