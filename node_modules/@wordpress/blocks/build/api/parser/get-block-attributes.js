 ...
 */
const toBooleanAttributeMatcher = matcher => (0, _compose.pipe)([matcher, // Expected values from `attr( 'disabled' )`:
//
// <input>
// - Value:       `undefined`
// - Transformed: `false`
...
const matcherFromSource = (0, _memize.default)(sourceConfig => {
  switch (sourceConfig.source) {
    ...
    case 'tag':
      return (0, _compose.pipe)([(0, _matchers.prop)(sourceConfig.selector, 'nodeName'), nodeName => nodeName ? nodeName.toLowerCase() : undefined]);
...
function getBlockAttributes(blockTypeOrName, innerHTML) {
  ...
  const blockAttributes = (0, _lodash.mapValues)(blockType.attributes, (schema, key) => getBlockAttribute(key, schema, doc, attributes, innerHTML));
