...
function isUnmodifiedBlock(block) {
  ...
  if (!isUnmodifiedBlock[block.name]) {
    isUnmodifiedBlock[block.name] = (0, _factory.createBlock)(block.name);
  }
...
function __experimentalGetBlockAttributesNamesByRole(name, role) {
  ...
  const attributes = (_getBlockType = (0, _registration.getBlockType)(name)) === null || _getBlockType === void 0 ? void 0 : _getBlockType.attributes;
