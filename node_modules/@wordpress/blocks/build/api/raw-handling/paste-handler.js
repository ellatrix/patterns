...
var _slackParagraphCorrector = _interopRequireDefault(require("./slack-paragraph-corrector"));
...
function filterInlineHTML(HTML, preserveWhiteSpace) {
  HTML = (0, _utils.deepFilterHTML)(HTML, [_headRemover.default, _googleDocsUidRemover.default, _phrasingContentReducer.default, _commentRemover.default]);
...
function pasteHandler(_ref) {
  ...
  HTML = (0, _utils.deepFilterHTML)(HTML, [_slackParagraphCorrector.default]); // An array of HTML strings and block objects. The blocks replace matched
  // shortcodes.
  ...
  const blocks = pieces.map(piece => {
    ...
    return (0, _htmlToBlocks.htmlToBlocks)(piece, pasteHandler);
  ...
  if (mode === 'AUTO' && blocks.length === 1 && (0, _registration.hasBlockSupport)(blocks[0].name, '__unstablePasteTextInline', false)) {
    ...
    if (trimmedPlainText !== '' && trimmedPlainText.indexOf('\n') === -1) {
      return (0, _dom.removeInvalidHTML)((0, _serializer.getBlockInnerHTML)(blocks[0]), phrasingContentSchema).replace(trimRegex, '');
    }
  }
