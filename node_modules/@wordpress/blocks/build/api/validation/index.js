...
exports.DecodeEntityParser = void 0;
...
exports.getNormalizedLength = getNormalizedLength;
...
exports.isEqualAttributesOfName = void 0;
exports.isEqualTagAttributePairs = isEqualTagAttributePairs;
exports.isEqualTokensOfType = void 0;
...
function isEquivalentTextTokens(actual, expected) {
  let logger = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : (0, _logger.createLogger)();
...
const isEqualAttributesOfName = {
  ...
  style: (actual, expected) => {
    return (0, _es.default)(...[actual, expected].map(getStyleProperties));
  },
...
function getHTMLTokens(html) {
  let logger = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : (0, _logger.createLogger)();
...
function validateBlock(block) {
  ...
  const isFallbackBlock = block.name === (0, _registration.getFreeformContentHandlerName)() || block.name === (0, _registration.getUnregisteredTypeHandlerName)(); // Shortcut to avoid costly validation.

  if (isFallbackBlock) {
    return [true, []];
  }

  const logger = (0, _logger.createQueuedLogger)();
  const blockType = (0, _utils.normalizeBlockType)(blockTypeOrName);
  let generatedBlockContent;

  try {
    generatedBlockContent = (0, _serializer.getSaveContent)(blockType, block.attributes);
  } catch (error) {
...
function isValidBlockContent(blockTypeOrName, attributes, originalBlockContent) {
  (0, _deprecated.default)('isValidBlockContent introduces opportunity for data loss', {
    since: '12.6',
    plugin: 'Gutenberg',
