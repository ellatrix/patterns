...
exports.__experimentalHasContentRoleAttribute = void 0;
...
function isMatchingSearchTerm(state, nameOrType, searchTerm) {
  ...
  const blockType = getNormalizedBlockType(state, nameOrType);
  const getNormalizedSearchTerm = (0, _compose.pipe)([// Disregard diacritics.
  //  Input: "média"
  term => (0, _removeAccents.default)(term !== null && term !== void 0 ? term : ''), // Lowercase.
  //  Input: "MEDIA"
  term => term.toLowerCase(), // Strip leading and trailing whitespace.
  //  Input: " media "
  term => term.trim()]);
  const normalizedSearchTerm = getNormalizedSearchTerm(searchTerm);
  const isSearchMatch = (0, _compose.pipe)([getNormalizedSearchTerm, normalizedCandidate => normalizedCandidate.includes(normalizedSearchTerm)]);
...
const __experimentalHasContentRoleAttribute = (0, _rememo.default)((state, blockTypeName) => {
...
exports.__experimentalHasContentRoleAttribute = __experimentalHasContentRoleAttribute;
