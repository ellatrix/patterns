...
export const getBlockTypes = createSelector(state => Object.values(state.blockTypes), state => [state.blockTypes]);
/**
...
export const getBlockVariations = createSelector((state, blockName, scope) => {
...
export function isMatchingSearchTerm(state, nameOrType, searchTerm) {
  ...
  const blockType = getNormalizedBlockType(state, nameOrType);
  const getNormalizedSearchTerm = pipe([// Disregard diacritics.
  //  Input: "média"
  term => removeAccents(term !== null && term !== void 0 ? term : ''), // Lowercase.
  //  Input: "MEDIA"
  term => term.toLowerCase(), // Strip leading and trailing whitespace.
  //  Input: " media "
  term => term.trim()]);
  const normalizedSearchTerm = getNormalizedSearchTerm(searchTerm);
  const isSearchMatch = pipe([getNormalizedSearchTerm, normalizedCandidate => normalizedCandidate.includes(normalizedSearchTerm)]);
...
export const __experimentalHasContentRoleAttribute = createSelector((state, blockTypeName) => {
