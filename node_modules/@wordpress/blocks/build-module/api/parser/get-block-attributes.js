...
export const toBooleanAttributeMatcher = matcher => pipe([matcher, // Expected values from `attr( 'disabled' )`:
//
// <input>
// - Value:       `undefined`
// - Transformed: `false`
...
export function getBlockAttribute(attributeKey, attributeSchema, innerDOM, commentAttributes, innerHTML) {
  let value;
...
export const matcherFromSource = memoize(sourceConfig => {
  switch (sourceConfig.source) {
    ...
    case 'tag':
      return pipe([prop(sourceConfig.selector, 'nodeName'), nodeName => nodeName ? nodeName.toLowerCase() : undefined]);
...
export function getBlockAttributes(blockTypeOrName, innerHTML) {
  ...
  const blockAttributes = mapValues(blockType.attributes, (schema, key) => getBlockAttribute(key, schema, doc, attributes, innerHTML));
